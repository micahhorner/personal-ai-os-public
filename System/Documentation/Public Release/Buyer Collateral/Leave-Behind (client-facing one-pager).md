...
created: 2026-08-13
updated: 2026-08-14
summary: "Client-facing explanation of the Personal AI OS v1.64.4 release and its security boundaries."
---
...
date: 2026-08-13
audience: CLIENT-FACING
claim_basis: Personal AI OS v1.64.4 release mechanics; qualification claims require exact tag-bound release evidence
```
...
8. **The product publishes scoped evidence.** The v1.64.4 release has target-bound machine evidence distributed with its GitHub release assets. Retained earlier evidence remains historical and does not qualify v1.64.4.
