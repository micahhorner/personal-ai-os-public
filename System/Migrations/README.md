...
## Historical 1.64.4 data status

`historical-sources.yaml` pins the exact 23 supported official source commits,
...
1.64.4 directly; none requires an intermediate migration. Exact no-write
postcondition edges preserve pristine v1.64.1, v1.64.2, and v1.64.3 sources while
