...
## Historical 1.64.2 data status

`historical-sources.yaml` pins the exact 21 supported official source commits,
...
1.64.2 directly; none requires an intermediate migration.
