...
## Historical 1.64.6 data status

`historical-sources.yaml` pins the exact 25 supported official source commits,
...
1.64.6 directly; none requires an intermediate migration. Exact no-write
postcondition edges preserve pristine v1.64.1, v1.64.2, v1.64.3, v1.64.4, and v1.64.5 sources while
...
Official 1.64.2 through 1.64.5 edges 023–026 use the same exact no-write MIT
