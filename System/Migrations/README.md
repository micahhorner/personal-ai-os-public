...
## Historical 1.64.3 data status

`historical-sources.yaml` pins the exact 22 supported official source commits,
...
1.64.3 directly; none requires an intermediate migration. Exact no-write
postcondition edges preserve pristine v1.64.1 and v1.64.2 sources while
