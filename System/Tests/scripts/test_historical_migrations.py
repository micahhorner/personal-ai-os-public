...
class TestHistoricalMigrationEvidence(unittest.TestCase):
    ...
    def test_bridge_and_final_release_ref_status_are_explicit(self):
        ...
        self.assertEqual(
            unresolved["target_release_ref"], "refs/tags/v1.64.5"
        )
        self.assertEqual(
    ...
    def test_direct_estate_has_24_supported_sources_to_1645(self):
        available = discover(VAULT / "System/Migrations")
        direct = [
            item for item in available
        ...
        self.assertEqual(len(generated_direct), 24)
        self.assertEqual(len({item.from_version for item in direct}), 24)
    ...
    def test_022_identity_exact_no_write_and_custom_license_refusal(self):
        ...
        self.assertEqual(manifest.to_version, "1.64.5")
