...
**162 authority-marked files — 103 canonical · 59 derived.**
...
<!-- docgen:test-census -->
**1176 unit tests across 74 suites** (`python3 -m unittest discover -s System/Tests/scripts`).
...
| `test_historical_migrations.py` | 15 |
...
<!-- docgen:file-census -->
**708 files on disk** (excluding `.git`, generated state, caches, and the editor/runtime projections).
