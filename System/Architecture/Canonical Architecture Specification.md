...
**159 authority-marked files — 103 canonical · 56 derived.**
...
<!-- docgen:test-census -->
**1167 unit tests across 73 suites** (`python3 -m unittest discover -s System/Tests/scripts`).
...
| `test_historical_migrations.py` | 12 |
...
<!-- docgen:file-census -->
**698 files on disk** (excluding `.git`, generated state, caches, and the editor/runtime projections).
