...
**161 authority-marked files — 103 canonical · 58 derived.**
...
<!-- docgen:test-census -->
**1175 unit tests across 74 suites** (`python3 -m unittest discover -s System/Tests/scripts`).
...
| `test_historical_migrations.py` | 14 |
...
<!-- docgen:file-census -->
**705 files on disk** (excluding `.git`, generated state, caches, and the editor/runtime projections).
